...
import { OverviewIcon } from "../../assets/Icon/Icon";
      ...
      <div className="bg-[#363740] w-[20%] h-[100vh] pt-[37px] fixed top-0 left-0">
        ...
        <ul className="navbar-list flex flex-col">
          <li>
            <NavLink
              to="/"
              className="nav-item text-[#A4A6B3] flex items-center duration-300 gap-6 pl-[32px] border-l-[3px] py-[18px] border-transparent hover:border-[#DDE2FF]"
            >
              <OverviewIcon />
